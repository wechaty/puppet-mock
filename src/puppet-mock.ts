...
class PuppetMock extends Puppet {
   ...
   *
   */
  override async conversationReadMark (conversationId: string, haveRead?: boolean) : Promise<void> {
    log.verbose('PuppetService', 'conversationRead(%s, %s)', conversationId, haveRead)
  }
